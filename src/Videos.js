...
function Videos() {
  return (
    <div className="videos">
      <h2>Recommended</h2>
      <div className="videos__vids">
        <VideoCard
          title={"Match Highlights - Iran 0:1 USA - FIFA World Cup Qatar 2022 | JioCinema & Sports18"
            .toString()
            .slice(0, 50)
            .concat("...")}
          views="5.6K"
          timestamp="3 days ago"
          channelImage="https://yt3.ggpht.com/ytc/AMLnZu9MAV-U_htHIltAPJs8VBNXDlPFBrbBEqFwGJdRtA=s48-c-k-c0x00ffffff-no-rj"
          channel="JioCinema"
          image="https://i.ytimg.com/vi/9-cp9x10TDk/hq720.jpg?sqp=-oaymwEcCOgCEMoBSFXyq4qpAw4IARUAAIhCGAFwAcABBg==&rs=AOn4CLDVKbz3AvndAMmgBHD_xrpM2hOY5w"
        />
        <VideoCard
          title={"This Watch Broke The Internet… | The G-Shock Casioak GA-2100 & GMA-S2100"
            .toString()
            .slice(0, 40)
            .concat("...")}
          views="1.6M"
          timestamp="3 years ago"
          channelImage="https://yt3.ggpht.com/9gjIp29za3xes8AQ2oDrVhoLt-asJo2X56-M-qaHlORTp0k_9uK99WxxSzBQNHvfsGcfR1NzIQs=s48-c-k-c0x00ffffff-no-rj"
          channel="WatchGecko"
          image="https://cdn.shopify.com/s/files/1/0609/1636/7523/files/G-Shock-Casioak-GA2100-WatchGecko12.jpg"
        />
        <VideoCard
